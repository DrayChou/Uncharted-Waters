...
- 论坛里流传的旧 `EC 码` / `动态修改器` 只覆盖 `1.9CIII` 或更早版本，原帖作者明确说明 `1.9D` 及之后版本不适用。
- 因此针对当前仓库里的 `强化版/ROM/MD-1.9E6.7z`，如果要做“模拟器金手指”式的改金币/改数值，需要重新为 `1.9E6` 做地址搜索，不能直接照抄旧码。
- 相关整理见 [`../强化版/1.9E6论坛整理.md`](../强化版/1.9E6论坛整理.md)。
